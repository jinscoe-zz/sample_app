...
describe User do
  ...
  it "should reject invalid email addresses" do
    addresses = %w[user@foo,com THE_USER_at_foo.bar.com first.last@foo.]
    addresses.each do |address|
      valid_email_user = User.new(@attr.merge(:email => address))
  ...
  describe "password encryption" do
    ...
    describe "has_password? method" do
      ...
      it "should retunr true if the passwords match" do
        @user.has_password?(@attr[:password]).should be_true
      end
      
      it "should retunr false if the passwords do not match" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email address with no user" do
        User.authenticate("thisdoesn@gmail.com", @attr[:password]).should be_nil
      end
      
      it "should return return the user on a match" do
