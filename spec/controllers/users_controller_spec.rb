...
render_views
  ...
  describe "GET index" do
    ...
    describe "for signed in" do
      ...
      before(:each) do
        ...
        Factory(:user, :email  => "another@example.org")
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = {:name => "New User", :email => "valid@email.com", :password => "foobar", :password_confirmation => "foobar"}
      end
       ...
       it "should create a user" do
        ...
        it "should redirect to the user show pae" do
          post :create, :user => @attr
  ...
  describe "follow pages" do
    describe "when not signed in" do
      it "should proted 'following'" do
        get :following, :id => 1
        response.should redirect_to(signin_path) 
      end
      
      it "should proted 'followers'" do
        get :followers, :id => 1
        response.should redirect_to(signin_path) 
      end
